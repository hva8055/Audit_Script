        ...
        # Map selections to script paths
            if os_choice == "Windows 11":
                if(self.check_and_set_policy_for_user()):
                    ...
                    return
                if "L1" in level:
                    script_path = r"\Windows\Audit_script_l1.ps1"
                elif "L2" in level:
                    script_path = r"\Windows\Audit_scriptl2.ps1"
                elif "L3" in level:
                    script_path = r"\Windows\Audit_scriptl3.ps1"
            elif os_choice == "Ubuntu":
                if "L1" in level:
                    script_path = r"Ubuntu/level1.sh" # Address for script
                elif "L2" in level:
                    script_path = r"Ubuntu/level2.sh" # Address for script
                elif "L3" in level:
                    script_path = r"Ubuntu/level3.sh" # Address for script
